...
export default function TaxInfoPanel({ className = '' }: TaxInfoPanelProps) {
  return (
    <Card
      className={`bg-blue-50 dark:bg-blue-950 border-blue-200 dark:border-blue-800 mb-6 ${className}`}
      role="region"
    ...
    >
      <CardHeader className="flex flex-row items-center gap-2">
        ...
        <CardTitle
          id="info-panel-title"
          className="text-base sm:text-sm font-semibold text-blue-800 dark:text-blue-200"
        >
      ...
      <CardContent>
        ...
        >
          ...
          <div className="flex items-start" role="listitem">
            ...
            ></span>
            <span className="leading-relaxed">
              <strong>BBNKB</strong> 12.5% dari harga jual yang ada di notice
              STNK
            </span>
          </div>
          <div className="flex items-start" role="listitem">
            ...
            ></span>
            <span className="leading-relaxed">
              <strong>PKB</strong> kepemilikan ke-1 tarif 16%, ke-2 dan
              seterusnya tarif bertambah 8%
            </span>
          </div>
          <div className="flex items-start" role="listitem">
            <span
            ...
            ></span>
            <span className="leading-relaxed">
              <strong>Pajak Progresif</strong> = selisih PKB motor saat ini
              dengan motor pertama
            </span>
          </div>
        </div>
      </CardContent>
